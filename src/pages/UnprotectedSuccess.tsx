  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-background p-4">
      <div className="bg-white rounded-lg shadow-lg p-8 max-w-3xl w-full text-center">
        ...
        <p className="mb-6">You have successfully logged in. Here is your information:</p>
        ...
        <Button variant="destructive" className="w-full" onClick={() => navigate("/")}>Logout</Button>
      </div>
    </div>
  );
};

export default UnprotectedSuccess; 